        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Welcome to NetPersonas Registration Page!</h1>
              <p class="text-lead text-white">NetPersonas is a pioneering platform that taps into the potential of machine learning to revolutionise the corporate photography landscape.</p>
            </div>
          </div>
        </div>
      </div>
