...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
  	...
  	<hr class="horizontal dark mt-0">
    		...
    		<ul class="navbar-nav">
				...
				<li class="nav-item">
					{% if request.user.is_superuser %}
						<a href="{% url 'admin:index' %}" class="nav-link {% if 'index' in segment %} active {% endif %}"></a>
					{% else %}
						<a href="{% url 'index' %}" class="nav-link {% if 'index' in segment %} active {% endif %}"></a>
					{% endif %}
					<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  		...
  		<div class="sidenav-footer mx-3 ">
			...
			<a class="btn btn-primary btn-sm mb-0 w-100" href="https://appseed.us/product/argon-dashboard2-pro/django/" 
			target="_blank" type="button">PRO Version</a>
  		</div>
	</hr>
</aside>